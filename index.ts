...
let EJ_COMPONENTS = [EJ_GRID_COMPONENTS, EJ_CHART_COMPONENTS, EJ_DIAGRAM_COMPONENTS, EJ_OVERVIEW_COMPONENTS, EJ_SUNBURSTCHART_COMPONENTS,
    ...
    EJ_NUMERICTEXTBOX_COMPONENTS, EJ_CURRENCYTEXTBOX_COMPONENTS, EJ_PERCENTAGETEXTBOX_COMPONENTS, EJ_TIMEPICKER_COMPONENTS,
    EJ_TOOLBAR_COMPONENTS, EJ_MENU_COMPONENTS, EJ_AUTOCOMPLETE_COMPONENTS, EJ_MASKEDIT_COMPONENTS, EJ_TREEVIEW_COMPONENTS,
    EJ_SCHEDULE_COMPONENTS, EJ_KANBAN_COMPONENTS, EJ_RIBBON_COMPONENTS, EJ_PIVOTGRID_COMPONENTS,
    EJ_PIVOTCHART_COMPONENTS, EJ_PIVOTSCHEMADESIGNER_COMPONENTS, EJ_PIVOTTREEMAP_COMPONENTS, EJ_PIVOTGAUGE_COMPONENTS,
    EJ_RATING_COMPONENTS, EJ_LISTBOX_COMPONENTS, EJ_LISTVIEW_COMPONENTS,
    ...
    EJ_CHECKBOX_COMPONENTS, EJ_RADIOBUTTON_COMPONENTS, EJ_TOGGLEBUTTON_COMPONENTS,
    EJ_DATETIMEPICKER_COMPONENTS, EJ_DATERANGEPICKER_COMPONENTS,
