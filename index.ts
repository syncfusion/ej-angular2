...
let EJ_COMPONENTS = [EJ_ACCORDION_COMPONENTS, EJ_AUTOCOMPLETE_COMPONENTS, EJ_BARCODE_COMPONENTS, EJ_BULLETGRAPH_COMPONENTS, EJ_BUTTON_COMPONENTS,
                     EJ_CHART_COMPONENTS, EJ_CHECKBOX_COMPONENTS, EJ_CIRCULARGAUGE_COMPONENTS, EJ_COLORPICKER_COMPONENTS, EJ_CURRENCYTEXTBOX_COMPONENTS, EJ_DATEPICKER_COMPONENTS, 
                     EJ_DATETIMEPICKER_COMPONENTS, EJ_DIAGRAM_COMPONENTS, EJ_DIALOG_COMPONENTS, EJ_DIGITALGAUGE_COMPONENTS, EJ_DROPDOWNLIST_COMPONENTS,
                     EJ_FILEEXPLORER_COMPONENTS, EJ_GANTT_COMPONENTS, EJ_GRID_COMPONENTS, EJ_KANBAN_COMPONENTS, EJ_LINEARGAUGE_COMPONENTS, EJ_HEATMAP_COMPONENTS, EJ_HEATMAPLEGEND_COMPONENTS, EJ_LISTBOX_COMPONENTS, 
                     EJ_LISTVIEW_COMPONENTS, EJ_MAP_COMPONENTS, EJ_MASKEDIT_COMPONENTS, EJ_MENU_COMPONENTS, EJ_NAVIGATIONDRAWER_COMPONENTS, EJ_NUMERICTEXTBOX_COMPONENTS, 
                     EJ_OVERVIEW_COMPONENTS, EJ_PDFVIEWER_COMPONENTS, EJ_PERCENTAGETEXTBOX_COMPONENTS, EJ_PIVOTCHART_COMPONENTS, EJ_PIVOTGAUGE_COMPONENTS,
                     EJ_PIVOTGRID_COMPONENTS, EJ_PIVOTSCHEMADESIGNER_COMPONENTS, EJ_PIVOTTREEMAP_COMPONENTS, EJ_PROGRESSBAR_COMPONENTS, EJ_RADIALMENU_COMPONENTS, EJ_RADIALSLIDER_COMPONENTS,
                     EJ_RADIOBUTTON_COMPONENTS, EJ_RANGENAVIGATOR_COMPONENTS, EJ_RATING_COMPONENTS, EJ_REPORTVIEWER_COMPONENTS, EJ_RIBBON_COMPONENTS, EJ_ROTATOR_COMPONENTS,
                     EJ_RTE_COMPONENTS, EJ_SCHEDULE_COMPONENTS, EJ_SCROLLER_COMPONENTS, EJ_SIGNATURE_COMPONENTS, EJ_SLIDER_COMPONENTS, EJ_SPARKLINE_COMPONENTS, EJ_SPLITTER_COMPONENTS,
                     EJ_SPREADSHEET_COMPONENTS, EJ_TAB_COMPONENTS, EJ_TAGCLOUD_COMPONENTS, EJ_TILE_COMPONENTS, EJ_TIMEPICKER_COMPONENTS, EJ_TOGGLEBUTTON_COMPONENTS,
                     EJ_TOOLBAR_COMPONENTS, EJ_TREEGRID_COMPONENTS, EJ_TOOLTIP_COMPONENTS, EJ_TREEMAP_COMPONENTS, EJ_TREEVIEW_COMPONENTS, EJ_UPLOADBOX_COMPONENTS, EJ_WAITINGPOPUP_COMPONENTS
                    ];
