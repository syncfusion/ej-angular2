...
let Inputs = Utils.AngularizeInputs(['badge', 'caption', 'cssClass', 'enablePersistence', 'height',
    'imageClass', 'imagePosition', 'imageTemplateId', 'imageUrl', 'liveTile',
    'tileSize', 'width', 'showRoundedCorner', 'allowSelection', 'backgroundColor',
    'badge.maxValue', 'badge.minValue', 'caption.enabled', 'caption.alignment', 'caption.position',
    'caption.icon', 'liveTile.enabled', 'liveTile.imageClass', 'liveTile.imageTemplateId', 'liveTile.imageUrl',
    'liveTile.type', 'liveTile.updateInterval', 'liveTile.text'], ['badge.value', 'badge.enabled', 'badge.text', 'badge.position', 'caption.text']);
