...
export class TemplateElement {
    ...
    clearTempalte() {
        let templateObject = this.__element.__parent.widget.angularTemplate || this.__element.widget.angularTemplate;
...
export function CreateTemplateDirective(args: {
    ...
    return Directive(args).Class({
     ...
     constructor: [ElementRef, ViewContainerRef, TemplateRef, ejArgs.type, function (el: ElementRef, viewContainerRef: ViewContainerRef, templateRef: TemplateRef<any>, widget: EJComponents<any, any>) {  
            this.tags = ejArgs.tags;
            this.complexProperties = ejArgs.complexes;
