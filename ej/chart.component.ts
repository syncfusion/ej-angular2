...
export let TrendlineDirective = CreateComplexDirective({
...
export let TrendlinesDirective = CreateArrayTagDirective('trendlines', 'e-series>e-trendlines', TrendlineDirective);

export let PointDirective = CreateComplexDirective({
...
export let PointsDirective = CreateArrayTagDirective('points', 'e-series>e-points', PointDirective);

export let SeriesDirective = CreateComplexDirective({
    ...
    queries: {
        _Trendlines : new ContentChild(TrendlinesDirective),
        _points : new ContentChild(PointsDirective),
    }
}, {
...
export let SeriesCollectionDirective = CreateArrayTagDirective('series', 'ej-chart>e-seriescollection', SeriesDirective);

export let IndicatorDirective = CreateComplexDirective({
...
export let IndicatorsDirective = CreateArrayTagDirective('indicators', 'ej-chart>e-indicators', IndicatorDirective);

export let AnnotationDirective = CreateComplexDirective({
...
export let AnnotationsDirective = CreateArrayTagDirective('annotations', 'ej-chart>e-annotations', AnnotationDirective);

export let PrimaryXAxisStripLineDirective = CreateComplexDirective({
...
export let PrimaryXAxisStripLineCollectionDirective = CreateArrayTagDirective('primaryXAxis.stripLine', 'ej-chart>e-primaryxaxis-striplinecollection', PrimaryXAxisStripLineDirective);

export let PrimaryYAxisStripLineDirective = CreateComplexDirective({
...
export let PrimaryYAxisStripLineCollectionDirective = CreateArrayTagDirective('primaryYAxis.stripLine', 'ej-chart>e-primaryyaxis-striplinecollection', PrimaryYAxisStripLineDirective);

export let RowDefinitionDirective = CreateComplexDirective({
...
export let RowDefinitionsDirective = CreateArrayTagDirective('rowDefinitions', 'ej-chart>e-rowdefinitions', RowDefinitionDirective);

export let ColumnDefinitionDirective = CreateComplexDirective({
...
export let ColumnDefinitionsDirective = CreateArrayTagDirective('columnDefinitions', 'ej-chart>e-columndefinitions', ColumnDefinitionDirective);
...
export let ChartComponent = CreateComponent('Chart', {
    ...
    template: '',
    queries: {
        _series : new ContentChild(SeriesCollectionDirective),
        _indicators : new ContentChild(IndicatorsDirective),
        _annotations : new ContentChild(AnnotationsDirective),
        _primaryXAxis_stripLine : new ContentChild(PrimaryXAxisStripLineCollectionDirective),
        _primaryYAxis_stripLine : new ContentChild(PrimaryYAxisStripLineCollectionDirective),
        _rowDefinitions : new ContentChild(RowDefinitionsDirective),
        _columnDefinitions : new ContentChild(ColumnDefinitionsDirective),
    }
}, {
...
export const EJ_CHART_COMPONENTS: Type<any>[] = [ChartComponent , TrendlinesDirective, PointsDirective, SeriesCollectionDirective, IndicatorsDirective, AnnotationsDirective, PrimaryXAxisStripLineCollectionDirective, PrimaryYAxisStripLineCollectionDirective, RowDefinitionsDirective, ColumnDefinitionsDirective, TrendlineDirective, PointDirective, SeriesDirective, IndicatorDirective, AnnotationDirective, PrimaryXAxisStripLineDirective, PrimaryYAxisStripLineDirective, RowDefinitionDirective, ColumnDefinitionDirective ];
